...
const react = (
  ...
  >
    ...
    <g stroke="rgb(88, 196, 220)" strokeWidth="1">
...
const testingLibrary = new Image();
testingLibrary.src = "/images/icons/testing-library.png";
testingLibrary.alt = "React Testing Library";

export default {
  svg: [html, css, javascript, react, vite, router, three, webpack, vitest],
